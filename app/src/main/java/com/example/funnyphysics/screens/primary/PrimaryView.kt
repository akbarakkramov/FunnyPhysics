...
import com.example.funnyphysics.Navigation.BottomNavGraph
...
fun PrimaryView(pvm: PrimaryViewModel) {
    ...
    Scaffold(bottomBar = {
        ...
        Column(
            ...
            Text(text = "Funny Physics", fontSize = 28.sp, fontWeight = FontWeight.Bold, modifier = Modifier.padding(vertical = 8.dp))
